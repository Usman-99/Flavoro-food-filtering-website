...
const Cart = () => {
  ...
  return (
    <>
      <div
        className={` overflow-y-scroll scroll-smooth fixed right-0 top-0 w-full lg:w-[20vw] h-full p-4 ps-2 bg-white mb-3 ${
      ...
      >
        ...
        <div className={`${cartItems.length <= 2 ? "absolute bottom-0" : " "}`}>
